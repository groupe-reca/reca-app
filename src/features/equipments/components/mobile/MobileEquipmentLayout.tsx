...
type MobileEquipmentLayoutProps = {
  /** Injectées dans le Header compact (`MobileHeader`) via le contexte partagé — 0-2 boutons, ≥48px. */
  headerActions?: ReactNode
  children: ReactNode
}

/** Cadre de page mobile commun aux pages Équipements (liste) — câble `useMobileHeaderActions` une seule fois. */
export function MobileEquipmentLayout({ headerActions, children }: MobileEquipmentLayoutProps) {
