...
type MobileMissionLayoutProps = {
  /** Injectées dans le Header compact (`MobileHeader`) via le contexte partagé — 0-2 boutons, ≥48px. */
  headerActions?: ReactNode
  children: ReactNode
}

/** Cadre de page mobile commun à la liste Missions — câble `useMobileHeaderActions` une seule fois. */
export function MobileMissionLayout({ headerActions, children }: MobileMissionLayoutProps) {
