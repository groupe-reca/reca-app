...
type MobileInterventionLayoutProps = {
  /** Injectées dans le Header compact (`MobileHeader`) via le contexte partagé — 0-2 boutons, ≥48px. */
  headerActions?: ReactNode
  children: ReactNode
}

/** Cadre de page mobile commun aux pages Interventions (liste/détail) — mirrors `MobileContractLayout.tsx`. */
export function MobileInterventionLayout({ headerActions, children }: MobileInterventionLayoutProps) {
